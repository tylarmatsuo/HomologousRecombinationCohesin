...
SEPARATION = 120
SEPARATION_AFTER_DSB = 120 # Optional post-DSB separation; set to None if this feature isn't needed

# Simulation Timescales
simulation_cycles = 5
steady_state_relax_1D = 10000 # Run 1D simulation for this long before recording positions
trajectoryLength = 101000 # Total time to run 3D simulation, including dsb_time but not including steady_state_relax_1D
dsb_time = 1000 # Let simulation evolve for this long before inducing DSB and beginning to record
delay_before_FPT = 30

ctcf_sites = []
LIFETIME_CTCF = LIFETIME

dsb_site = 1500 # Hyper-effective TAD boundary
dsb_present = True
